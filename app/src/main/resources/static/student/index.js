...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/ncp08-bucket-8888-member-photo/${student.photo}`;
        document.querySelector("#f-photo").src = `https://xdtsr9b13607.edge.naverncp.com/GSFX9blfmc/${student.photo}?type=f&w=80&h=80&faceopt=true&ttype=jpg`;
      } /*else {
